...
const ChatTemplate = () => {
  return (
    <div className="mx-auto flex h-screen w-full max-w-screen-2xl flex-col overflow-hidden">
      {/* Responsive main content */}
      <div className="flex flex-1 flex-col overflow-hidden md:flex-row">
        {/* ticket listing */}
        <div className="flex min-h-[300px] w-full flex-col overflow-hidden border-b border-gray-200 bg-white md:w-1/2 md:border-r md:border-b-0 lg:w-1/3">
          {" "}
          {/* Filters + Tickets */}{" "}
          <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
            ...
            <ScrollShadow className="hide-scrollbar flex-1 space-y-4 overflow-y-auto p-2 sm:p-4">
              {" "}
              {/* Ticket 1 */}{" "}
              <div
                className="rounded-md bg-blue-50 p-4 shadow-sm transition hover:bg-gray-50"
                style={{
                  cursor: "pointer",
        ...
        {/* ticket details */}
        <div className="flex min-h-[300px] w-full flex-1 flex-col overflow-hidden bg-white">
          {/* Ticket Info Header */}
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
              ...
              <div className="flex w-full flex-col gap-2 sm:flex-row sm:items-center md:w-auto">
                <div className="flex w-full items-center space-x-2 sm:w-auto">
                  <label className="shrink-0 text-xs font-medium text-gray-700">
                    Status:
                  </label>
                  <Select
                    defaultValue="Status"
          ...
          <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden">
            ...
            {/* Reply Section */}
            <div className="top-0 right-0 bottom-0 left-0 flex-1 border-t border-gray-300 bg-white p-2">
              <div className="flex w-full flex-col sm:flex-row sm:items-start sm:space-x-2">
                  ...
                  <div className="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center sm:gap-2">
                      ...
                      <Select
                        ...
                        className="w-full text-sm sm:w-40 md:w-48 lg:w-56"
                      />
                    </div>
                    <div className="flex w-full justify-end sm:w-auto">
                      <Button className="bg-atoll hover:bg-opacity-90 w-full rounded-lg px-2 py-2 text-sm text-white sm:w-auto sm:px-4 sm:py-2 md:px-5 md:py-2.5 lg:px-6 lg:py-3">
                        Send Response
                      </Button>
                    </div>
                  </div>
