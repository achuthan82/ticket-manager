...
export default function TicketChat() {
    ...
    return (
        <>
            <TicketChatHeader ticketId={ticketId} />
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 mb-6">
                        ...
                        <div className="space-y-6 mt-10">
                            ...
                            <div className="flex items-start space-x-3">
                                <img src="https://ui-avatars.com/api/?name=Sarah+Wilson&background=0a5a78&color=fff&size=40" alt="" className="w-10 h-10 rounded-full" />
                            ...
                            {/* Admin Response */}
                            <div className="flex items-start space-x-3">
                                <img src="https://ui-avatars.com/api/?name=Admin+Support&background=5ab453&color=fff&size=40" alt="" className="w-10 h-10 rounded-full" />
                                <div className="flex-1">
                                    <div className="flex items-center space-x-2 mb-1">
                        ...
                        <div className="mt-6 border-t pt-6">
                            ...
                            <div className="flex items-center justify-between mt-3">
                                ...
                                <button onClick="sendReply()" className="bg-black text-white px-4 py-2 rounded-lg hover:bg-opacity-90">
                                    Send Reply
                                </button>
                            </div>
                        </div>
